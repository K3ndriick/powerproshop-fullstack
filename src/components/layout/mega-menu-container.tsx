...
export function MegaMenuContainer({ children }: MegaMenuContainerProps) {
  return (
    <div 
      className="absolute top-0 left-0 right-0 before:content-[''] before:absolute before:h-4 before:-top-4 before:left-0 before:right-0 before:bg-transparent opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none group-hover:pointer-events-auto"
    >
